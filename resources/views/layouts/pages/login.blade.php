                ...
                <div class="w-full max-w-md mx-auto">
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            <div class="flex items-center">
                                <label class="custom-checkbox relative flex items-start">
                                    <input type="checkbox" class="sr-only" name="remember-me">
                    ...
                    <div class="mt-8">
                        ...
                        <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3">
                            <a href="#" class="flex items-center justify-center px-4 py-2 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
