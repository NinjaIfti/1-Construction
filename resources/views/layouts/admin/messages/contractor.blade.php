...
<div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-semibold text-navy">Messages from {{ $contractor->name }}</h1>
            <p class="text-gray-500 mt-1">{{ $contractor->company_name }}</p>
        </div>
    ...
    <div class="bg-white shadow overflow-hidden rounded-lg">
        ...
        @else
            <div class="px-6 py-10 text-center">
                ...
                <p class="mt-1 text-sm text-gray-500">Start a conversation with this contractor.</p>
                <div class="mt-6">
