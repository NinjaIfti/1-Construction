...
<div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
    <div class="mb-6">
        ...
        <p class="text-gray-500 mt-1">Send a message to a contractor</p>
    </div>
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <form action="{{ route('admin.messages.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
            @csrf
            <div class="mb-6">
                <label for="recipient_id" class="block text-sm font-medium text-gray-700 mb-1">Recipient (Contractor)</label>
            ...
            <div class="flex items-center justify-end space-x-3">
                <a href="{{ route('admin.messages.index') }}" class="inline-flex justify-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    Cancel
                </a>
