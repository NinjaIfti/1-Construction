...
<div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
    <div class="mb-6">
        ...
        <p class="text-gray-500 mt-1">
            ...
            @if($message->contractor)
                from {{ $message->contractor->name }} ({{ $message->contractor->company_name }})
            @endif
        </p>
    </div>
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <form action="{{ route('admin.messages.store-reply', $message) }}" method="POST" enctype="multipart/form-data" class="p-6">
            @csrf
            <div class="mb-6">
            ...
            <div class="flex items-center justify-end space-x-3">
                <a href="{{ route('admin.messages.show', $message) }}" class="inline-flex justify-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    Cancel
                </a>
