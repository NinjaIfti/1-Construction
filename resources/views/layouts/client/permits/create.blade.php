...
<div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
    <div class="mb-6">
        <h1 class="text-2xl font-semibold text-navy">Submit a Permit</h1>
        <p class="text-gray-500 mt-1">Complete the form below to submit a new permit request</p>
    </div>
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <form action="{{ route('client.permits.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
            @csrf
            ...
            <div class="mb-6">
                ...
                <p class="mt-1 text-sm text-gray-500">
                    Don't see your project? <a href="{{ route('projects.create') }}" class="text-blue-500 hover:underline">Create a new project</a> first.
                </p>
            </div>
            ...
            <div class="flex justify-end space-x-3">
                <a href="{{ route('client.permits.index') }}" class="inline-flex justify-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    Cancel
                </a>
