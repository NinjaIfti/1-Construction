<section class="hero-section-navy relative min-h-[85vh] flex items-center overflow-hidden bg-gradient-to-b from-[#0A2240] to-[#061628]">
    ...
    <div class="container mx-auto px-6 relative z-10">
        <div class="flex flex-col lg:flex-row items-center">
            ...
            <div class="w-full lg:w-1/2 text-white mb-10 lg:mb-0 transform transition-all duration-700 translate-y-0 opacity-100 flex flex-col items-start" 
                ...
                <p class="text-xl mb-8 max-w-lg opacity-90 leading-relaxed">
                ...
                <div class="mb-10 space-y-5">
                    <div class="flex items-center group">
                        <div class="w-12 h-12 rounded-full bg-[#E31B23] bg-opacity-15 flex items-center justify-center mr-4 shadow-md group-hover:bg-opacity-25 transition-all duration-300">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#E31B23" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="group-hover:scale-110 transition-transform duration-300">
                                <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path>
                                <polyline points="22 4 12 14.01 9 11.01"></polyline>
                            </svg>
                        </div>
                        <span class="text-lg group-hover:text-[#ff4b52] transition-colors duration-300">Expert navigation through regulatory requirements</span>
                    </div>
                    ...
                    <div class="flex items-center group">
                        ...
                        <span class="text-lg group-hover:text-[#ff4b52] transition-colors duration-300">Faster approval timelines</span>
                    </div>
                    ...
                    <div class="flex items-center group">
                        ...
                        <span class="text-lg group-hover:text-[#ff4b52] transition-colors duration-300">Comprehensive documentation management</span>
                    </div>
                </div>
    ...
    <div class="absolute inset-0 overflow-hidden z-0">
        <svg width="400" height="400" viewBox="0 0 200 200" class="absolute -top-24 -right-24 opacity-10 animate-float" 
        ...
        <svg width="600" height="600" viewBox="0 0 200 200" class="absolute -bottom-48 -left-24 opacity-10 animate-float-reverse" 
             style="animation: floatReverse 20s ease-in-out infinite;">
    ...
    <!-- Enhanced Red accent line at the bottom with animation -->
    <div class="absolute bottom-0 left-0 w-full h-2 bg-gradient-to-r from-[#E31B23] to-[#ff4b52]"></div>
