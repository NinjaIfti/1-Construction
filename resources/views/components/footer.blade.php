<footer class="bg-[#0A2240] py-16 pb-8 relative" style="background-color: #0A2240;">
    <div class="container mx-auto px-6">
        ...
        <div class="flex flex-col lg:flex-row justify-between">
            ...
            <div class="mb-10 lg:mb-0 lg:w-1/4">
                <a href="/" class="inline-block mb-5">
                    <div class="flex items-center">
                        <span class="text-[#E31B23] text-4xl font-bold mr-1">1</span>
                        <div class="flex flex-col">
                            <span class="text-white text-lg font-bold leading-tight">CONTRACTOR</span>
                            <span class="text-white text-lg font-bold leading-tight">SOLUTIONS</span>
                        </div>
                    </div>
                </a>
                <p class="text-gray-100 mb-5 max-w-xs">
                    Your trusted partner for streamlined construction permitting nationwide.
                </p>
                <div class="flex space-x-4">
                    <a href="#" target="_blank" class="text-white hover:text-[#E31B23] transition duration-300">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 lg:w-2/3">
                <!-- Services Column -->
                <div>
        ...
        <!-- Copyright Section -->
        <div class="border-t border-white border-opacity-10 mt-10 pt-6">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <div class="flex items-center mb-4 md:mb-0">
                    <span class="text-white">©</span>
                    <span class="current-year text-white mx-1"></span>
                    <span class="text-white">1 Contractor Solutions. All Rights Reserved.</span>
                </div>
                <div class="flex space-x-6">
                    <a href="/terms" class="text-white hover:text-gray-300 transition duration-300">Terms of Use</a>
                    <a href="/privacy" class="text-white hover:text-gray-300 transition duration-300">Privacy Policy</a>
                </div>
            </div>
        </div>
    </div>
...
<style>
/* Backup styles in case Tailwind classes don't apply correctly */
footer {
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // If jQuery is available, it will override the above
